...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC ,                        KC_ENT , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, KC_LGUI,          KC_LGUI, KC_SPC , KC_SPC,        KC_SPC ,KC_RSFT, RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TAB,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ESC,  KC_DEL ,                        KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_COLN, KC_DQT , \
    KC_LSFT, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_ENT,  KC_SPC ,                        KC_ENT , KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_QUES, KC_RSFT, \
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_TAB,  KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_TILD, KC_DEL ,                        KC_BSPC, KC_GRV,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_DQT , \
    KC_LSFT, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_SPC ,                        KC_ENT , KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_PLUS, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             LOWER,   KC_SPC ,_______,        _______,KC_ENT , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
