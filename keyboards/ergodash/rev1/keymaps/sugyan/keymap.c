...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LALT,          KC_LGUI, KC_SPC ,KC_SPC,         KC_BSPC,KC_RSFT, RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_LSFT, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_SPC ,                        KC_ENT , KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             LOWER,   KC_SPC ,KC_DEL,         KC_BSPC,KC_ENT , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
